    ...
    $('#calendar').fullCalendar({
        ...
        */
        ...
        eventMouseover: function(calEvent, domEvent) {
	        var layer =	"<div class='events-layer' class='fc-transparent' style='position:absolute; width:100%; height:100%; top:-1px; text-align:right; z-index:100'><a><img class='minicon' src='/static/actions/delete.png' onClick='ui.remove_entry(\""+calEvent.id+"\");'></a>  <a><img class='minicon' src='/static/actions/edit.png' onClick='ui.edit_entry(\""+calEvent.id+"\");'></a></div>";
//	        layer.fadeIn('slow');
	        $(this).append(layer);
	        return false;
	},
